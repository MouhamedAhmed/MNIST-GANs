...
class Generator(nn.Module):
    ...
    def __init__(self, z_dim=10, im_dim=28, hidden_dim=128, device='cpu'):
        ...
        self.gen = nn.Sequential(
            nn.ConvTranspose2d(z_dim, im_dim*8, 4, 1, 0),
            nn.BatchNorm2d(im_dim*8),
    ...
    def get_generator_block(self, input_dim, output_dim):
        ...
        return nn.Sequential(
            nn.ConvTranspose2d(input_dim, output_dim, 4, 2, 1),
...
class Discriminator(nn.Module):
    ...
    def __init__(self, im_dim=28, hidden_dim=128):
        ...
        #     nn.Conv2d(1, im_dim, 4, 2, 1, bias=False),
        #     nn.LeakyReLU(0.2, inplace=True),
        #     nn.Conv2d(im_dim, im_dim * 2, 4, 2, 1, bias=False),
        #     nn.BatchNorm2d(im_dim * 2),
        #     nn.LeakyReLU(0.2, inplace=True),
        #     # state size. (im_dim*2) x 16 x 16
        #     nn.Conv2d(im_dim * 2, im_dim * 4, 4, 2, 1, bias=False),
        #     nn.BatchNorm2d(im_dim * 4),
        #     nn.LeakyReLU(0.2, inplace=True),
        #     # state size. (im_dim*4) x 8 x 8
        #     nn.Conv2d(im_dim * 4, 1, 4, 2, 1, bias=False),
        #     nn.Sigmoid()
        # )
        # print(self.main)
